...
use App\Commands\Admin\SubCategoryStoreCommand;
...
class SubCategoriesController extends Controller
{
    ...
    public function __construct() {
        $this->view     = 'admin.general.subcategories.';
        $this->index    = 'admin/general/subcategories/index.';
        $this->create   = 'admin/general/subcategories/create.';
        $this->edit     = 'admin/general/subcategories/edit.';
    }
    ...
    public function store(Request $request)
    {
        try {
            $data = $request->all();
            $result = $this->dispatch(new SubCategoryStoreCommand($data, $request, 'new'));
    ...
    public function update(Request $request)
    {
        try {
            $data = $request->all();
            $result = $this->dispatch(new SubCategoryStoreCommand($data, $request, 'edit'));
    ...
    public function destroy(Request $request, $id)
    {
        try {
            $data = $request->all();
            $data['id']         = $id;
            $result = $this->dispatch(new SubCategoryStoreCommand($data, $request, 'delete'));
    ...
    public function getList(Request $request) {
        try {
            ...
            return Datatables::of($list)
                    ->rawColumns(['id', 'category_id', 'sub_category_name', 'status', 'action'])
                    ...
                    ->addColumn('name', function($record) {
                        return $record->sub_category_name;
                    })
                    ...
                    ->addColumn('action', function($record) {
                        return '<a href="'.\URL::route('admin.subcategories.edit', [ 'id' => $record->id ]).'" class="btn blue btn-icon-only btn-outline"><i class="fa fa-edit"></i></a>&nbsp;
                                <a href="javascript:;" onClick="deleteRow(\''.$record->id.'\');" id="'.$record->id.'" class="btn red-thunderbird btn-icon-only btn-outline" data-url="' . \URL::route('admin.subcategories.delete', ['id' => $record->id]) . '"><i class="fa fa-trash-o"></i></a>';       
                    })
                    ->make(true);
        } catch (Exception $e) {
