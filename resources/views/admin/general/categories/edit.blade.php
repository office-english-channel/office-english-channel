            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    ...
                    <div class="portlet-body">
                        {!! Form::model($record, array('route' => array('admin.categories.update') , 'class' => 'form-horizontal', 'id' => 'add_categories', 'files' => true))  !!}
                            {!! Form::hidden('id') !!}
...
@section('pageleveljs')
    ...
    <script type="text/javascript">
        ...
        //code for submit data on enter form controls
            $('#add_categories').find('input').keypress(function(e) {
