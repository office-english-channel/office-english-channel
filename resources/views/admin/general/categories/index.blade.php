            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{!! URL::route('admin.categories.create') !!}" class="btn green-turquoise btn-outline">
                    ...
                    <div class="portlet-body">
                        <div class="table">
                            <table class="table table-hover table-light" id="categories_list_tbl">
                                <thead>
                                    <tr class="uppercase">
                                        <th width="5%"> # </th>
                                        <th width="65%"> Name </th>
...
<script type="text/javascript">
    ...
    function loaduserlist() {
        $('#categories_list_tbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! URL::route('admin.categories.getlist') !!}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
