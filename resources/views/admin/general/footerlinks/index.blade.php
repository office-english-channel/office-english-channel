                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="{!! URL::route('admin.general.footerlinks.create') !!}" class="btn green-turquoise btn-outline">
                            ...
                            <div class="table">
                                <table class="table table-hover table-light" id="administrators_list_tbl">
                                    <thead>
                                        <tr class="uppercase">
                                            <th width="5%"> # </th>
                                            <!-- <th width="35%"> {!! trans($lang.'page_id_clmn_lbl') !!} </th> -->
                                            <th width="60%"> {!! trans($lang.'label_clmn_lbl') !!} </th>
    ...
    <script type="text/javascript">
        ...
        function loaduserlist() {
            $('#administrators_list_tbl').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! URL::route('admin.general.footerlinks.getlist') !!}",
                columns: [
                    {data: 'id', name: 'id'},
