            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    ...
                    <div class="portlet-body">
                        <div class="table">
                            <table class="table table-hover table-light" id="servicerequests_list_tbl">
                                <thead>
                                    <tr class="uppercase">
                                        <th width="5%"> # </th>
                                        <th width="35%"> Name </th>
...
<script type="text/javascript">
    ...
    function loaduserlist() {
        $('#servicerequests_list_tbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! URL::route('admin.servicerequests.getlist') !!}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
    ...
    function deleteRow(id) {
        bootbox.dialog({
            message : "Are you sure want to delete this Inquiry-Form?",
