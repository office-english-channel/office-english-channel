            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{!! URL::route('admin.servicerequests.index') !!}" class="btn green-turquoise btn-outline">
                                Back 
                    ...
                    <div class="portlet-body">
                        {!! Form::model($record, array('class' => 'form-horizontal', 'id' => 'add_servicerequests', 'files' => true))  !!}
                            {!! Form::hidden('id') !!}
...
@section('pageleveljs')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var form1 = $('#add_servicerequests');
            var error1 = $('.alert-danger', form1);
            $("#add_servicerequests").validate({
        ...
        //code for submit data on enter form controls
            $('#add_servicerequests').find('input').keypress(function(e) {
