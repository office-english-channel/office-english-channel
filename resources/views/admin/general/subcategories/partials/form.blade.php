...
<div class="col-md-6">
    <div class="row margin-bottom-5">
        <div class="form-group">
            ...
            <div class="col-md-7">
                {!! Form::text('sub_category_name', null, array('class' => 'form-control', 'placeholder' => 'Name' , 'id' => 'sub_category_name', 'maxlength' => '90', 'tabindex' => $index++)) !!}
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-7">
                ...
                <div class="fileinput @if($record->cover_id!='')  {!! 'fileinput-exists' !!} @else {!! 'fileinput-new' !!} @endif" data-provides="fileinput" id="cover_media_div">
                    ...
                    <div>
                        ...
                        <a href="javascript:;" class="btn red btn-outline btn-circle fileinput-exists mt-ladda-btn ladda-button" data-style="expand-right" onclick="removeimage('cover_media_id', 'cover_media_div', 'sub_categories', 'cover_id', '{!! $record->id !!}', $(this))" tabindex="{!! $index++ !!}"> <span class="ladda-label"> <i class="fa fa-trash"></i> Delete </span> </a>
                    </div>
                </div>
...
<div class="row margin-bottom-5">
    ...
    <div class="col-md-4">
        ...
        <a href="{!! URL::route('admin.subcategories.index') !!}" class="btn dark btn-outline btn-circle" tabindex="{!! $index++ !!}">
