            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{!! URL::route('admin.subscribers.index') !!}" class="btn green-turquoise btn-outline">
                                Back 
                    ...
                    <div class="portlet-body">
                        {!! Form::model($record, array('route' => array('admin.subscribers.update') , 'class' => 'form-horizontal', 'id' => 'add_subscribers', 'files' => true))  !!}
                            {!! Form::hidden('id') !!}
...
@section('pageleveljs')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var form1 = $('#add_subscribers');
            var error1 = $('.alert-danger', form1);
            $("#add_subscribers").validate({
        ...
        //code for submit data on enter form controls
            $('#add_subscribers').find('input').keypress(function(e) {
