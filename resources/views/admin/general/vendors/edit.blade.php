            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    ...
                    <div class="portlet-body">
                        {!! Form::model($record, array('route' => array('admin.vendors.update') , 'class' => 'form-horizontal', 'id' => 'add_vendors', 'files' => true))  !!}
                            {!! Form::hidden('id') !!}
    ...
    <script type="text/javascript">
        ...
        //code for submit data on enter form controls
            ...
            $(function(){
                ...
                var subCategoryID   = '{{$record->sub_category_id}}';
                            ...
                            if(res){
                                ...
                                $.each(res,function(key,value){
                                    if(subCategoryID == value.id){
                                       $("#sub_category_id").append('<option selected="selected" value="'+value.id+'">'+value.sub_category_name+'</option>');
                                    } else {
