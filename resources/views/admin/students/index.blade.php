            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit ">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{!! URL::route('admin.students.create') !!}" class="btn green-turquoise btn-outline">
                    ...
                    <div class="portlet-body">
                        <div class="table">
                            <table class="table table-hover table-light" id="students_list_tbl">
                                <thead>
                                    <tr class="uppercase">
                                        <th width="5%"> # </th>
                                        <th width="50%"> Name </th>
...
<script type="text/javascript">
    ...
    function loaduserlist() {
        $('#students_list_tbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! URL::route('admin.students.getlist') !!}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
